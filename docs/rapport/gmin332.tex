...
\fancyhead[RE]{Projet Gestion de données complexes GMIN332}
...
\def\titre{\LARGE Manipulation de schémas de concepts dédiés \\Partie 1}
\def\sstitre{Projet Gestion de données complexes GMIN332\\Rapport (Novembre 2012)}
\def\auteurs{
